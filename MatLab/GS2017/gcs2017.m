...
% --- Executes during object creation, after setting all properties.
function axPosition_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axPosition (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate axPosition
handles.axPosition=hObject; % tag for this axis, which I call axesX in this example
