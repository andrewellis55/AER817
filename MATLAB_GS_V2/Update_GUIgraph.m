...
switch dataSource
    ...
    case 3
        hold on
        plot(handles.payload_x, handles.payload_y, '.-k','Parent', handles.Graph1);
        plot(handles.device_x, handles.device_y,'.-b','Parent',handles.Graph1);
        hold off
end
